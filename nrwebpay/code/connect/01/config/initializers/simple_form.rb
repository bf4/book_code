...
SimpleForm.setup do |config|
  ...
  # whole input.
  config.wrappers(
      :default, class: :input, hint_class: :field_with_hint,
  ...
  # by default
  # in this configuration, which is recommended due to some quirks from
  # different browsers.
  # To stop SimpleForm from generating the novalidate option, enabling the
  # HTML5 validations,
