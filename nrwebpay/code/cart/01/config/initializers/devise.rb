...
Devise.setup do |config|
  ...
  # config.secret_key =
  # '66102411410dad4fed4e7ce166372f224a5964f5f864e762014bd14f431bfd6d1875eac41f0
  # 02bc6cb5f17189429e75b726523cb95a1b049641f1ce8285edff5'
  ...
  # given strategies,
  # for example, `config.http_authenticatable = [:database]` will
  ...
  # a value less than 10 in other environments. Note that, for bcrypt
  # (the default
  # algorithm), the cost increases exponentially with the number of stretches
  # (e.g.
  # a value of 20 is already extremely slow: approx. 60 seconds for 1
  # calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper =
  # '14e1455bb76c84fad8ad6f64f6a3023361e49521f07b984e6818bcffa82a5cb524d3c83cfa
  # 2eb72239151f6a88d45729358e1d189b588f7128e9d880af52763b'
