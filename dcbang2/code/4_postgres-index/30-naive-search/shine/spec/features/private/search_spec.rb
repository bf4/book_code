...
feature "search" do
  ...
  before do
    ...
    @matches = [
      ...
      Customer.create!(customer_attributes.().merge(last_name: "Patrice")),
      Customer.create!(customer_attributes.().merge(first_name: "patrick")),
      Customer.create!(customer_attributes.().merge(first_name: "PATTY")),
      Customer.create!(customer_attributes.().merge(last_name: "paterson")),
      Customer.create!(customer_attributes.().merge(last_name: "Patt")),
      Customer.create!(customer_attributes.().merge(last_name: "Patton")),
  ...
  scenario "search by name" do
    ...
    within ".search-results tbody" do
      expect(page).to have_selector("tr", count: 9)
    end
  end
