...
feature "customers search" do
  ...
  scenario "see our angular app start to take shape" do
    sign_up_and_log_in
    ...
    within "h1.searchedFor" do
      expect(page).to have_content("bob123@somewhere.net")
    end
    screenshot! filename: "angular-app-takes-shape.png"
  end
