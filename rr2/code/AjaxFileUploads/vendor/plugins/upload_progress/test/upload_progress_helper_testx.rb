...
#---
require File.dirname(__FILE__) + 'action_view/helpers/date_helper'
require File.dirname(__FILE__) + 'action_view/helpers/number_helper'
require File.dirname(__FILE__) + 'action_view/helpers/asset_tag_helper'
require File.dirname(__FILE__) + 'action_view/helpers/form_tag_helper'
require File.dirname(__FILE__) + 'action_view/helpers/tag_helper'
require File.dirname(__FILE__) + 'action_view/helpers/javascript_helper'
require File.dirname(__FILE__) + 'action_view/helpers/upload_progress_helper'
