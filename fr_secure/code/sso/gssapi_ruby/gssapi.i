...
/*
  Document-method: gss_import_name
    ...
    call-seq:
      gss_import_name(GssBufferDesc name_buffer, opaque_name_type) -> 
      [MajorStatus, MinorStatus, gss_name_t]
...
// gss_acquire_cred(...) -> [MajorStatus, MinorStatus, 
//                           gss_cred_id_t, gss_OID_set, TimeRec]
...
// -> [MajorStatus, MinorStatus, ReturnedContext, actual_mech_type, 
...
OM_uint32 KRB5_CALLCONV gss_init_sec_context
  ...
  gss_OID                 IN,    /* mech_type (used to be const) 
                          should use -> GSS_C_NO_OID for KRB5*/
